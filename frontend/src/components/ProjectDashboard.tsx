...
export const ProjectDashboard: React.FC<ProjectDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-950 px-5 py-8 text-slate-100 sm:px-10">
